...
import { SKILLS_DIR_NAME, SKILL_FILE_NAME } from '@khiwniti/common/constants/skills'
import { SkillFrontmatterSchema, type SkillDefinition } from '@khiwniti/common/types/skill'
import fs from 'fs'
