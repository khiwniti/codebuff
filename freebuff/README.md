...
For everything else — what Freebuff does, how it works, FAQ, and how it relates to Openbuff — see the [repo root README](../README.md). We keep that one up to date as the single source of truth.
