...
} from '@khiwniti/common/constants/freebuff-models'
import { getRateLimitsByModel } from '@khiwniti/common/types/freebuff-session'
import { formatFreebuffHardBlockedPrivacySignals } from '@khiwniti/common/util/freebuff-privacy'
import { pluralize } from '@khiwniti/common/util/string'

import type { FreebuffSessionResponse } from '../types/freebuff-session'
import type { FreebuffIpPrivacySignal } from '@khiwniti/common/types/freebuff-session'
          ...
          {session?.status === 'banned' && (
            <>
              ...
              <text style={{ fg: theme.muted, wrapMode: 'word' }}>
                ...
                think this is a mistake, contact support@openbuff.com. Press
                Ctrl+C to exit.
              </text>
            </>
          )}
