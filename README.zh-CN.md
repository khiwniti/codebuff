...
**[Openbuff](https://openbuff.com)** 是一款开源的 AI 编程助手，能根据自然语言指令直接修改你的代码库。**[Freebuff](https://www.npmjs.com/package/freebuff)** 是它的免费、广告支持版本——无需订阅、无需积分、零配置。
...
在我们的[评测](evals/README.md)中，Openbuff 在 175+ 个真实开源仓库的编码任务上以 61% 对 53% 的成绩领先 Claude Code。
...
```typescript
import { OpenbuffClient } from '@codebuff/sdk'
...
不想订阅？**[Freebuff](https://www.npmjs.com/package/freebuff)** 是 Openbuff 的免费版本——无需订阅、无需积分、零配置，装上就能用。
...
**OpenRouter 上的任何模型**：Claude Code 把你锁死在 Anthropic 的模型上，Openbuff 不一样——它支持 [OpenRouter](https://openrouter.ai/models) 上的所有模型，从 Claude、GPT 到 Qwen、DeepSeek 这类专用模型都行。可以按任务切换模型，也能随时用上最新发布的模型，不必等平台跟进。

**复用已发布的智能体**：把社区[已发布的智能体](https://www.openbuff.com/store)拼起来用，少走弯路。Openbuff 智能体就是新一代的 MCP！
...
- 📚 **完善文档**或撰写教程
- 💡 **分享想法**：在 [GitHub Issues](https://github.com/OpenbuffAI/codebuff/issues) 留言
...
**文档**：[openbuff.com/docs](https://openbuff.com/docs)

**社区**：[Discord](https://openbuff.com/discord)

**Issue 与想法**：[GitHub Issues](https://github.com/OpenbuffAI/codebuff/issues)

**贡献指南**：[CONTRIBUTING.md](./CONTRIBUTING.md) ——想贡献从这里开始！

**支持**：[support@openbuff.com](mailto:support@openbuff.com)

## Star 历史

[![Star History Chart](https://api.star-history.com/svg?repos=OpenbuffAI/codebuff&type=Date)](https://www.star-history.com/#OpenbuffAI/codebuff&Date)
