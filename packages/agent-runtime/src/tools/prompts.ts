import { endsAgentStepParam } from '@khiwniti/common/tools/constants'
import { toolParams } from '@khiwniti/common/tools/list'
import { AVAILABLE_SKILLS_PLACEHOLDER } from '@khiwniti/common/tools/params/tool/skill'
import { getToolCallString } from '@khiwniti/common/tools/utils'
import { buildArray } from '@khiwniti/common/util/array'
import { formatAvailableSkillsXml } from '@khiwniti/common/util/skills'
